<?php
	...
	class Register{
		...
		private function check_email_exists(){
			$stmt = $this->connectionDB->prepare('SELECT * FROM logueo WHERE email=:email');
		...
		private function create_user(){
			$stmt = $this->connectionDB->prepare('INSERT INTO logueo (email, password) VALUES (:email,:password)');
			$stmt->bindParam(':email',$this->email);
